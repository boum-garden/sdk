...
class TestDeviceState:
    ...
    def test__create_from_payload__works(self):
        payload_1 = {'maxPumpDuration': '10min', 'pumpState': 'off', 'refillTime': '01:53'}
        payload_2 = {'maxPumpDuration': '11min', 'pumpState': 'on', 'refillTime': '00:00'}
